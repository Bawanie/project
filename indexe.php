		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="indexe.php">Master Data</a></li>
	...
	<div class="container">
		<div class="content">
			...
			if(isset($_GET['aksi']) == 'delete'){
				$ename = $_GET['ename'];
				$cek = mysqli_query($connection, "SELECT * FROM employee WHERE ename='$ename'");
				if(mysqli_num_rows($cek) == 0){
					...
					$delete = mysqli_query($connection, "DELETE FROM employee WHERE ename='$ename'");
					if($delete){
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>
								...
								<a href="index.php?aksi=delete&ename='.$row['ename'].'" title="Delete Data" onclick="return confirm(\'Do you want to  delete '.$row['ename'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
